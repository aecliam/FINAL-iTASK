...
if(isset($_POST['add'])){
  ...
  $sql = "INSERT INTO scholars_shs (scholar_id, firstname, middlename, lastname, suffix, bdate, gender, contact, address, email, school, gradelvl, pgname, pgcontact, avatar, registration, report_card, valid_id, bgy_cert, payslip) 
			...
			<form method="POST">
				<div class="row">
					...
					<hr>
						...
						<div class="form-group">
							<label for="" class="control-label">Track/Strand</label>
							<select name="gender" class="custom-select custom-select-sm">
								<option value="Grade 7">STEM</option>
								<option value="Grade 8">ABM</option>
								<option value="Grade 8">HUMSS</option>
								<option value="Grade 8">TVL</option>
								<option value="Grade 8">GAS</option>
								<option value="Grade 8">Others</option>
							</select>
						</div>
						<div class="form-group">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=scholar_list_(SHS)'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
