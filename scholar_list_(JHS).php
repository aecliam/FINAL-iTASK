	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_scholar_(JHS)"><i class="fa fa-plus"></i> Add New Student</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT *,concat(lastname,', ', firstname,' ',middlename) as name FROM scholars_jhs order by concat(lastname,', ', firstname,' ',middlename) asc");
...
<script>
	...
	function delete_user($id){
		start_load()
		$.ajax({
			url:'ajax.php?action=delete_scholar_jhs',
			method:'POST',
			data:{id:$id},
