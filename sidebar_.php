...
-->
                ...
                <div class="iocn-link">
                        ...
                        <ul class="sub-menu">
                            <li><a href="./index.php?page=scholar_list_(JHS)">Junior Highschool</a></li>
                            <li><a href="./index.php?page=scholar_list_(SHS)">Senior Highschool</a></li>
                            <li><a href="./index.php?page=scholar_list_(CLG)">College</a></li>
                            <li><a href="./index.php?page=scholar_list_(GS)">Graduate School</a></li>
                            <li><a href="./index.php?page=scholar_list_(ALS)">ALS</a></li>
                            <li><a href="./index.php?scholar_list_(ARTISTS)">Artist</a></li>
                            <li><a href="./index.php?page=scholar_list_(ATHLETE)">Athlete</a></li>
                        </ul>
                </li>
