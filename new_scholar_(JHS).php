...
if(isset($_POST['add'])){
  ...
  $sql = "INSERT INTO scholars_jhs (scholar_id, firstname, middlename, lastname, suffix, bdate, gender, contact, address, email, school, gradelvl, pgname, pgcontact, avatar, registration, report_card, valid_id, bgy_cert, payslip) 
