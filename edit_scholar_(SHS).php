...
if(isset(($_GET["id"]))) {
    ...
    $qry = "SELECT * FROM scholars_shs WHERE id='$mm'";
...
if(isset($_POST['edit'])){
    ...
    $sql = "UPDATE scholars_shs SET firstname = '$firstname', middlename ='$middlename', lastname = '$lastname', suffix = '$suffix', bdate = '$birthdate', gender = '$gender', contact = '$contact', address = '$address', email = '$email', school = '$school', gradelvl = '$gradelvl', pgname = '$pgname', pgcontact = '$pgcontact', avatar = '$avatar' 
    WHERE id = '$id'";
    if($conn->query($sql)){
