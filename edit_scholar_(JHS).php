...
if(isset(($_GET["id"]))) {
    ...
    $qry = "SELECT * FROM scholars_jhs WHERE id='$mm'";
...
if(isset($_POST['edit'])){
    ...
    $sql = "UPDATE scholars_jhs SET firstname = '$firstname', middlename ='$middlename', lastname = '$lastname', suffix = '$suffix', bdate = '$birthdate', gender = '$gender', contact = '$contact', address = '$address', email = '$email', school = '$school', gradelvl = '$gradelvl', pgname = '$pgname', pgcontact = '$pgcontact', avatar = '$avatar' 
    WHERE id = '$id'";
    if($conn->query($sql)){
		...
		<div class="card-body">
			<form method="POST">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=scholar_list_(JHS)'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
