...
Class Action {
	...
	function delete_scholar_jhs(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM scholars_jhs where id = ".$id);
		if($delete)
			return 1;
	}
	function delete_scholar_shs(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM scholars_shs where id = ".$id);
		if($delete)
			return 1;
	}
	function delete_scholar_clg(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM scholars_clg where id = ".$id);
		if($delete)
			return 1;
	}
	function delete_scholar_gs(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM scholars_gs where id = ".$id);
		if($delete)
			return 1;
	}
