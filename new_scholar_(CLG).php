...
if(isset($_POST['add'])){
  ...
  $sql = "INSERT INTO scholars_clg (scholar_id, firstname, middlename, lastname, suffix, bdate, gender, contact, address, email, school, gradelvl, pgname, pgcontact, avatar, registration, report_card, valid_id, bgy_cert, payslip) 
					...
					<hr>
						...
						<div class="form-group">
							...
							<select name="gender" class="custom-select custom-select-sm">
								...
								<option value="BS Applied Math">BS Applied Math</option>
								<option value="BS Stat">BS Stat</option>
